...
public class GuiProcess {
	...
	public Vector<Vector<String>> getClientRow(Vector<Client> allClient)
	...
	public Vector<Vector<String>> getRowTrainer(Vector<Trainer> allTrainer)
			throws ClassNotFoundException, SQLException {
		Vector<Vector<String>> result = new Vector<Vector<String>>();
	...
	public Vector<Vector<String>> getRowPrograme(Vector<Program> prog)
			throws ClassNotFoundException, SQLException {
		Vector<Vector<String>> result = new Vector<Vector<String>>();
	...
	public Vector<Client> getClient() throws ClassNotFoundException,
			SQLException {
	...
	public Vector<Trainer> getTrainer() throws ClassNotFoundException,
			SQLException {
	...
	public Vector<Program> getProgram() throws ClassNotFoundException,
			SQLException {
	...
	public Vector<Commodity> getCommodity() throws ClassNotFoundException,
			SQLException {
	...
	/******************* select ********************/
	public Vector<Client> selectClient(final String key, final String str)
			throws ClassNotFoundException, SQLException {
	...
	public Vector<Trainer> selectTrainer(final String key, final String str)
			throws ClassNotFoundException, SQLException {
		Vector<Trainer> allTrainer;
	...
	public Vector<Program> selectProgram(final String key, final String str)
			throws ClassNotFoundException, SQLException {
		Vector<Program> allProgram;
	...
	public Vector<Commodity> selectCommodity(final String key, final String str)
			throws ClassNotFoundException, SQLException {
		Vector<Commodity> allCommodity;
	...
	public Member selectMember(final String key, final String str)
			throws ClassNotFoundException, SQLException {
		Member member;
		member = filemanager.selectMember(key, str);
		return member;
	}
	...
	public void add(Commodity commodity) throws ClassNotFoundException,
			SQLException {
		filemanager.add(commodity);
	}

	public void add(Program program) throws ClassNotFoundException,
			SQLException {
		filemanager.add(program);
	}

	public void add(Trainer trainer) throws ClassNotFoundException,
			SQLException {
	...
	public void update(Commodity commodity) throws ClassNotFoundException,
			SQLException {
		filemanager.updateCommodity(commodity);
	}

	public void update(Trainer trainer) throws ClassNotFoundException,
			SQLException {
		filemanager.updateTrainer(trainer);
	}

	public void update(Program program) throws ClassNotFoundException,
			SQLException {
		filemanager.updateProgram(program);
	}

	public void update(Member member) throws ClassNotFoundException,
			SQLException {
		filemanager.updateMember(member);
	}

	/******************* delete ********************/
	public void delete(final String index, final String table)
			throws ClassNotFoundException, SQLException {

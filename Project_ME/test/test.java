...
public class test {
	...
	public void selectClient() throws ClassNotFoundException, SQLException {
		...
		assertThat(clientComp1.elementAt(0).getTerminateDate(),
				is("2015-12-01"));
		...
		assertThat(clientComp2.elementAt(0).getTerminateDate(),
				is("2015-12-01"));
		...
		assertThat(clientComp3.elementAt(0).getTerminateDate(),
				is("2015-12-01"));
		...
		assertThat(clientComp4.elementAt(0).getTerminateDate(),
				is("2015-12-01"));
